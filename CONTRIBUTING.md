Contributing to vpaw
===============================

There are many ways to contribute to vpaw.

  * Submit a feature request or bug, or add to the discussion on the [vpaw issue tracker][is]
...
notify vpaw developers of your awesome contributions. Based on the
