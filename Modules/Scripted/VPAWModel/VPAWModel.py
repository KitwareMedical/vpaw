...
class VPAWModel(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = (
            "VPAWModel"  # TODO: make this more human readable by adding spaces
        )
...
information in <a href="https://github.com/organization/projectname#VPAWModel">module
documentation</a>.
"""
...
def registerSampleData():
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        ...
        thumbnailFileName=os.path.join(iconsPath, "VPAWModel1.png"),
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        # Category and sample name displayed in Sample Data module
        category="VPAWModel",
        sampleName="VPAWModel2",
        thumbnailFileName=os.path.join(iconsPath, "VPAWModel2.png"),
        # Download URL and target file name
        uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/"
        "1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97",
        fileNames="VPAWModel2.nrrd",
        checksums="SHA256:"
        "1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97",
        # This node name will be used when the data set is loaded
        nodeNames="VPAWModel2",
    )
...
class VPAWModelWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
...
class VPAWModelLogic(ScriptedLoadableModuleLogic):
...
class VPAWModelTest(ScriptedLoadableModuleTest):
    """
    ...
    def test_VPAWModel1(self):
        ...
        registerSampleData()
        inputVolume = SampleData.downloadSample("VPAWModel1")
